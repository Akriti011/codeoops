    ...
    def generate(self) -> DocumentationJob:
        ...
        try:
            ...
            backend_config = BackendConfig.from_cli(
                ...
                max_token_per_module=self.config.get('max_token_per_module', 8192),
                max_token_per_leaf_module=self.config.get('max_token_per_leaf_module', 4096),
                llm_timeout_seconds=self.config.get('llm_timeout_seconds', 180),
