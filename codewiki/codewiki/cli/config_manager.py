...
class ConfigManager:
    ...
    def load(self) -> bool:
        ...
        try:
            ...
            for change in self._config.apply_legacy_local_defaults():
                logger.warning("Local-model configuration migration: %s", change)
    ...
    def save(
        ...
        clear_fallback_model: bool = False,
        ...
        Args:
            ...
            clear_fallback_model: Disable fallback model selection
            default_output: Default output directory
            max_tokens: Maximum tokens for LLM response
            max_token_per_module: Maximum tokens per module for clustering
            max_token_per_leaf_module: Maximum tokens per leaf module
            max_depth: Maximum depth for hierarchical decomposition
            llm_timeout_seconds: Per-model request timeout in seconds
        ...
        if clear_fallback_model:
            self._config.fallback_model = None
        ...
        if llm_timeout_seconds is not None:
            self._config.llm_timeout_seconds = llm_timeout_seconds
