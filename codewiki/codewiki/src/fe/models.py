...
class JobStatus:
    ...
    main_model: Optional[str] = None
    commit_id: Optional[str] = None
    # Set when this job targets a repository CodeOops already placed on the
    # shared output volume (ZIP upload) instead of a GitHub URL CodeWiki
    # clones itself. See background_worker._process_job.
    local_repo_path: Optional[str] = None
